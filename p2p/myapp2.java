...
public class myapp2 extends JMenuBar
{
	...
	public myapp2() throws Exception
	{
			...
			JLabel searchtype = new JLabel( "Select " );
			...
			buttonPanel.setPreferredSize(new Dimension(200, 550));
			...
			JSplitPane b = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT,labelPanel,buttonPanel);
			b.setBorder(BorderFactory.createLineBorder(Color.red, 2) );	
			tabOne.add(labelPanel,BorderLayout.NORTH);					
			tabOne.add(buttonPanel,BorderLayout.SOUTH);			
