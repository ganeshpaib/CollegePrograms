...
public class myappTry extends JMenuBar implements Runnable
{
	...
	JTextField t1;
	String titles[] = new String[] {"File Name", "CLIENT IPADDR", "CLIENT NAME"};
 ...
 Object data1,data2,data3;
	 String nameClient, ipClient, fileClient;
...
public void run()
		{
			try
			{
				...
				else
				{
						...
						Socket sc=new Socket(InetAddress.getByName("localhost"),4444);
