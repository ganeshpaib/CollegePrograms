		...
		String grade,name,dept;
			switch(c)
			{
				case 1: System.out.println();
					...
					System.out.println("insert into emps values ('" + name + "'," + empno + ", '" + dept + "','" + grade + "'," + bpay + ")");

					String sql = "insert into emps values ('" + name + "'," + empno + ", '" + dept + "','" + grade + "'," + bpay + ")";
					...
					{}
					break;
				case 4: String sql1 = "select * from emps";
				...
				case 2: System.out.print("Enter the Employee No to Delete: ");
		    			empno=Integer.parseInt(dis.readLine());
		    			String sql2="delete from emps where empno="+empno;
				...
				case 3: System.out.print("Enter the Employee No to Update: ");
		    			...
		    			name=dis.readLine();
		     			...
		     			bpay=Integer.parseInt(dis.readLine());
		     			String sql3="update emps set name='"+name+"',dept='"+dept+"',grade="+grade+",bpay="+bpay+" where empno="+empno+";";
