...
Public Class disp_all_items
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As disp_all_items = CType(MyBase.Clone,disp_all_items)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "disp_all_items"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/disp_all_items.xsd"
