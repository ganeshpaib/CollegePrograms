...
Public Class display_all_items
    Inherits DataSet
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As display_all_items = CType(MyBase.Clone,display_all_items)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "display_all_items"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/display_all_items.xsd"
