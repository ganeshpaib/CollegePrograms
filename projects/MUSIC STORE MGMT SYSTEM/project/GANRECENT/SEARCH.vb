...
Public Class SEARCH
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As SEARCH = CType(MyBase.Clone,SEARCH)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "SEARCH"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/SEARCH.xsd"
    ...
    Public Class A_MUSIC_PURCHASEDataTable
        ...
        Public Overloads Function AddA_MUSIC_PURCHASERow(ByVal ALBUM_NAME As String, ByVal ARTIST As String, ByVal UNITS As Decimal, ByVal PRICE As Decimal, ByVal CATEGORY_ID As String, ByVal LANGUAGE As String, ByVal P_ID As String) As A_MUSIC_PURCHASERow
            Dim rowA_MUSIC_PURCHASERow As A_MUSIC_PURCHASERow = CType(Me.NewRow,A_MUSIC_PURCHASERow)
            rowA_MUSIC_PURCHASERow.ItemArray = New Object() {ALBUM_NAME, ARTIST, UNITS, PRICE, CATEGORY_ID, LANGUAGE, P_ID}
